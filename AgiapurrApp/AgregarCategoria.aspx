<%@ Page Title="Agregar Categoría" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="AgregarCategoria.aspx.cs" Inherits="AgiapurrApp.AgregarCategoria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid py-4" style="max-width: 700px;">
        ...
        <div class="mb-4 border-bottom pb-2">
            <h2 id="lblTitulo" runat="server" class="fw-bold text-dark mb-1">Agregar Nueva Categoría</h2>
            <p class="text-muted mb-0">Ingrese el nombre para la nueva clasificación del catálogo</p>
        </div>
        ...
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-body p-4 p-md-5">
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control border-start-0" placeholder="Ej: Bebidas, Almacén, Limpieza..." />
                    </div>
                    <asp:RequiredFieldValidator ErrorMessage="El nombre de la categoría es obligatorio" ControlToValidate="txtNombre" runat="server" CssClass="validator" Display="Dynamic" />
            ...
            <div class="card-footer bg-light p-4 border-top-0 rounded-bottom-4 d-flex justify-content-end gap-3">
                ...
                <button type="button" id="btnProcesarUI" runat="server" class="btn btn-success-custom px-4 d-flex align-items-center gap-2 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalSeguridadGuardar">
                    <span class="material-symbols-outlined fs-5">save</span> Guardar Categoría
                </button>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-4">
                <div class="modal-body text-center pt-5 pb-4 px-4">
                    ...
                    <p class="text-muted">Si cancelas ahora, no se guardarán los cambios realizados en esta categoría.</p>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-4">
                ...
                <div class="modal-body text-center pt-0 pb-4 px-4">
                    ...
                    <h4 class="fw-bold text-dark">¿Guardar categoría?</h4>
    ...
    <div class="modal fade" id="modalExito" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-4">
                ...
                <div class="modal-footer bg-light justify-content-center border-top-0 rounded-bottom-4 py-3">
                    <a href="Categorias.aspx" class="btn btn-success-custom px-5 fw-bold">Ir al Listado de Categorías</a>
                </div>
            </div>
        </div>
    </div>
