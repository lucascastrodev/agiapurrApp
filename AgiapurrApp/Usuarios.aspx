<%@ Page Title="Gestión de Usuarios" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="AgiapurrApp.Usuarios" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlMensaje" runat="server" Visible="false" role="alert">
        <div class="d-flex justify-content-between align-items-center">
            <asp:Label ID="lblMensaje" runat="server" CssClass="mb-0"></asp:Label>
                ...
                <asp:GridView ID="gvUsuarios" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-CssClass="col-acciones">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="btnRestablecer" runat="server"
                                    CssClass="btn btn-secondary btn-grilla me-1 shadow-sm"
                                    CommandName="RestablecerClave"
                                    CommandArgument='<%# Eval("Id") %>'
                                    OnClientClick="return confirm('¿Confirmás que querés blanquear la contraseña de este usuario? Se generará una clave aleatoria.');"
                                    ToolTip="Blanquear Contraseña">
